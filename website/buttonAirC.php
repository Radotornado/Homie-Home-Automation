...
<body>
  <div class='wrapper'>
	<div class='container'>
		<h1>HOMIE</h1>
		<h2><strong>Air conditioning</strong> is ON</h2>
		<br>
		<form class='form' action = 'buttonAirC.php' method = 'POST'>
			...
			<br><br>
			<input type = 'submit' class = 'buttonOff' name ='AirC_OFF' id='AirC_OFF' value = 'Аir conditioning OFF'>
			<br><br><br>
...
<body>
  <div class='wrapper'>
	<div class='container'>
		<h1>HOMIE</h1>
		<h2><strong>Air conditioning</strong> is OFF</h2>
		<br>
		<form class='form' action = 'buttonAirC.php' method = 'POST'>
			<input type = 'submit' class = 'buttonOn' name ='AirC_ON' id='AirC_ON' value = 'Air conditioning ON'>
			<br><br>
